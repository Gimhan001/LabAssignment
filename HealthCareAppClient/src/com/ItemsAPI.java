...
public class ItemsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = itemObj.insertItem(
				...
				request.getParameter("pSize"),
				request.getParameter("itemName"),
				request.getParameter("itemPrice"),
				request.getParameter("itemDiscount"),
				request.getParameter("costPrice"),
				request.getParameter("sellPrice"),
				request.getParameter("WhsellPrice"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = itemObj.updateItem(
				...
				paras.get("pSize").toString(),
				paras.get("itemName").toString(),
				paras.get("itemPrice").toString(),
				paras.get("itemDiscount").toString(),
				paras.get("costPrice").toString(),
				paras.get("sellPrice").toString(),
				paras.get("WhsellPrice").toString(),
